  ...
  const slidesData = [
    {
      ...
      quote:
        "ChatGPT simplifies problem-solving, providing instant solutions for startups.",
    ...
    },
    {
      ...
      quote:
        "We believe AI can enhance human capabilities and address global challenges.",
    ...
    },
    {
      ...
      quote:
        "Our deep learning work is transforming how machines process and generate language.",
    ...
    },
    {
      ...
      quote:
        "AI can greatly improve our lives, but we must be cautious about its potential risks.",
      ...
      <div className="w-full h-[100vh]  flex flex-col justify-between relative overflow-x-clip">
        ...
        <div className="w-full">
                ...
                <div className="relative ">
                  ...
                  <div className=" md:text-3xl lg:text-4xl 1500size:text-5xl md:p-2 1500size:p-4 text-center section2-title-bordered">
                    ...
                    <span className="section2-title-bordered-line-1">
                      <Encrypt
                        className="section2-title-bordered-line-2 mx-2 violetFont "
                        text={"Your ChatGPT"}
                      />
                ...
                <div className="flex flex-col md:border-l lg:border-l-0 md:border-t md:border-r md:border-b border-[#cacac6] justify-between min-h-[31rem] md:bg-[#fff] px-[5%] md:px-0 md:pl-[5%] 1500size:pl-[2%] ">
                  ...
                  <div className="flex-none md:flex  items-center border-[#cacac6] border-b md:border-none  bg-[#fff] md:bg-none">
                    <div
                      className={`flex ${
                        index === 0
                          ...
                          ? "w-[calc(18.6%-8px)]"
                          : "w-[calc(18.6%-8px)]"
                      } items-center gap-8 text-sm 1500size:text-lg`}
                    >
                    ...
                    <div className="flex gap-2 md:gap-8 relative  border-t border-[#cacac6] border-r md:border-none">
                      ...
                      <div>
                        <img
                          className=" w-[50px] h-[50px] lg:w-[70px]  lg:h-[70px] 1500size:w-[100px]  1500size:h-[100px]"
                          src={slide.imgSrc}
                          alt={slide.name}
                        />
                      </div>
                      ...
                      <div className="flex items-center  gap-4 md:gap-8">
                        <svg
                          className="w-[8px] md:w-[12px] rotate-90"
                          viewBox="0 0 6 4"
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                        ...
                        <div className="flex flex-col">
                          <div className="block md:hidden text-[15px]  violetFont">
                            {slide.name}
                          </div>
                          <div className="block md:hidden  text-sm  uppercase">
                            {slide.position}
                          </div>
                        </div>

                        <div className="hidden md:block md:text-lg 1500size:text-2xl violetFont">
                          {slide.name}
                        </div>
                      </div>
                      ...
                      <div className="flex md:hidden  absolute right-2 top-[50%] translate-y-[-50%] gap-2 items-center md:mx-[5%] 1500size:mx-[2%] ">
                        ...
                        >
                          <svg
                            className="w-[30px] h-[25px] rotate-180"
                            width="72"
                            height="66"
                            viewBox="0 0 52 46"
                            fill="none"
                    ...
                    {/* 포지션이름 모바일때는 숨김  */}
                    <div className="hidden md:block ml-[28%] md:ml-[10%] md:text-sm 1500size:text-lg uppercase">
                      {slide.position}
                    </div>
                  </div>
                  ...
                  <div className="flex gap-8 md:mb-8 px-[3%] md:px-0 ">
                    ...
                    <div className="md:text-sm 1500size:text-lg violetFont">
                      Try for yourself <span>Click Here</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="hidden md:flex relative  z-[9999999]  gap-4 items-center md:mx-[5%] 1500size:mx-[2%] ">
            ...
            >
              <svg
                className="md:w-[55px] md:h-[48px] 1500size:w-[72px] 1500size:h-[66px] rotate-180"
                width="72"
                height="66"
                viewBox="0 0 52 46"
                fill="none"
            ...
            >
              <svg
                className="md:w-[55px] md:h-[48px] 1500size:w-[72px]  1500size:h-[66px]"
                width="72"
                height="66"
                viewBox="0 0 52 46"
                fill="none"
