...
export const Section01 = () => {
  ...
  const qaData = [
    {
      question: "Q.When was ChatGPT released?",
      answer:
        "A. ChatGPT was first released in November 2020. Since then, it has gone through several updates and improvements, with more advanced versions like GPT-4 being developed to enhance its capabilities.",
    },
    {
      question: "Q.How does ChatGPT work?",
      answer:
        "A. ChatGPT is based on a language model trained on vast text data. It predicts the next word to generate human-like responses, enabling it to answer questions, hold conversations, and assist with various tasks.",
    },
    {
      question: "Q.What is ChatGPT used for?",
      answer:
        "A. ChatGPT is commonly used for customer support, content generation, programming assistance, and as a learning tool. It helps businesses automate tasks and individuals get quick, accurate answers to a wide range of topics.",
    },
    {
      question: "Q.How does ChatGPT ensure?",
      answer:
        "A. ChatGPT is designed to prioritize user privacy by not retaining personal conversation data after interactions. While it processes data to generate responses, it doesn’t store any personal information for future use.",
    },
          ...
          <div className="w-full md:w-[calc(94%-2px)] lg:w-[70%] z-10">
            ...
            <div className="flex mt-[25vh] mb-[10%] relative ">
              ...
              <div className="md:absolute top-[-66px] border-t border-l md:border-r border-b md:border-b-0 border-[#10101a] w-[66px] h-[66px] flex items-center justify-center">
                ...
                >
                  <path
                    d="M7.94425 0H3.20557L0 5.5149V16H7.94425V8.2383H4.73868V6.12766L7.94425 0ZM16.7944 6.12766L20 0H15.2613L12.0557 5.5149V16H20V8.2383H16.7944V6.12766Z"
                    fill="#10101A"
                  />
                </svg>
                        ...
                        {qaData.map((qa, index) => (
                          ...
                          <SwiperSlide key={index}>
                            ...
                            <div className="flex flex-col ">
                              <div className="p-4 flex items-center justify-start text-xl md:text-3xl 1200size:text-5xl h-[66px] md:h-[165px] ">
                                {" "}
                                {/* 보더값 128안에 정렬이쁘게하기 위해 사이즈 맞춤 */}
                                {qa.question}
                              </div>
              ...
              <div className="hidden md:block w-[calc(50%+1px)] relative">
                    ...
                    <SwiperSlide key={index}>
                      <li className="flex  justify-end">
                        <div className="flex items-center  ">
                          <p className=" pr-4 ">{item.maintext}</p>{" "}
                          {/* 메인 텍스트 */}
                          <p className=" p-4 ">{item.subtext}</p>{" "}
                          {/* 서브 텍스트 */}
                        </div>
                      </li>
                    </SwiperSlide>
                ...
                <ul className="text-right mt-4">
                  {modleName.map((item, index) => (
                    <li
                      key={index}
                      className={` flex justify-between border-t border-[#cacac6] pl-[5%] lg:pl-[22%] xl:pl-[42%] `}
                    >
                      <svg
          ...
          <div className="w-full flex items-end relative  md:pl-[5%]   ">
            <div className=" z-10 ">
              ...
              <div className="violetFont relative">
                <svg
                  className="absolute top-[13px]  md:top-[-35px] lg:top-[-130px] 1500size:top-0 z-10 w-[190px] md:w-[230px] md:h-[150px] lg:w-[300px] lg:h-[350px] 1500size:w-[450px] 1500size:h-[125px]"
                  viewBox="0 0 421 96"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    ...
                    d="M157.5 94H402.257C403.053 94 403.816 93.6839 404.379 93.1213L419 78.5"
                ...
                <div className="p-4 text-4xl md:text-5xl lg:text-6xl 1500size:text-8xl">
                  ChatGPT
                </div>
                <div className="p-4 text-4xl md:text-5xl lg:text-6xl 1500size:text-8xl">
                  AI
                ...
                <svg
                  className="absolute top-4 md:top-8 lg:top-12 1500size:top-[110px] w-[65px] md:w-[75px] lg:w-[90px] 1500size:w-[130px]"
                  height="180"
                  viewBox="0 0 115 88"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    ...
                    d="M2 2V68.7574C2 69.553 2.31607 70.3161 2.87868 70.8787L17.1213 85.1213C17.6839 85.6839 18.447 86 19.2426 86H62"
                    stroke="url(#paint0_linear_2309_6569)"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                  ></path>
                  <path
                    className="path-anim path-anim-right"
                    d="M62 86H110C111.657 86 113 84.6569 113 83V15.2426C113 14.447 112.684 13.6839 112.121 13.1213L100.5 1.5"
                    stroke="url(#paint1_linear_2309_6569)"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                  ></path>
                  <defs>
            ...
            <div className="w-auto absolute md:relative md:top-0 md:left-0 left-24 top-[93px] md:w-[45%] lg:w-[55%] md:text-sm lg:text-lg 1500size:text-2xl md:text-right">
              <p>
                Your personal expert in all crypto
                <br />& blockchain related topics.
              </p>
            </div>
